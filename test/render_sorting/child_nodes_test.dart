...
void main() {
  group('SortedChildNodes', () {
    group('with SortOrder ascending', () {
      ...
      group('after adding three nodes', () {
        final children = new SortedChildNodes.ascending(owner);
    ...
    group('with SortOrder descending', () {
      makeUnitNode(AtomicRenderUnit renderUnit) =>
          new RenderUnitNode(renderUnit, new ObservableValue(0));
      ...
      group('after adding three nodes', () {
        final children = new SortedChildNodes.descending(owner);
  ...
  group('UnsortedChildNodes', () {
    ...
    group('after adding three nodes', () {
      final children = new UnsortedChildNodes(owner);
